        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm" onClick={onClose}>
            ...
            >
                <div className="flex items-center justify-between px-5 py-4 bg-gradient-to-r from-zinc-950 to-orange-700 shrink-0">
                    <div>
                        <p className="text-[10px] text-orange-100 uppercase tracking-wider">Bon d&apos;Achat</p>
            ...
            {formOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-black/50 backdrop-blur-sm" onClick={closeFormPanel}>
                    <div
                        ...
                        onClick={(e) => e.stopPropagation()}
                    >
                        <div className="flex items-center justify-between px-5 py-3.5 bg-gradient-to-r from-zinc-950 via-zinc-900 to-orange-800 shrink-0">
                            <h3 className="text-white font-bold text-sm uppercase tracking-wide">
                                {editingId ? `Modifier Bon d'Achat ${currentRef}` : 'Nouveau Bon d\'Achat'}
                            </h3>
